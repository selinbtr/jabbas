...
function preMapper(){
    ...
    var userTrails = json(`https://www.hikingproject.com/data/get-trails?lat=${userLocation[0]}`+`&lon=${userLocation[1]}`+`&maxDistance=25&maxResults=15&key=${HIKE_API_KEY}`, markMaker)
}
